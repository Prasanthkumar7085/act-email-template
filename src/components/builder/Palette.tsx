    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between px-1">
                <div>
                    <h4 className="font-semibold text-gray-900 text-sm">Template Library</h4>
            ...
            <div className="grid gap-3">
                {PREDEFINED_TEMPLATES.map((t) => (
                    <div
                        key={t.id}
                        className="group relative bg-white border border-gray-200 rounded-xl p-3 hover:border-blue-400 hover:shadow-md transition-all cursor-pointer overflow-hidden"
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-3">
                            {/* Thumbnail */}
                            <div className="relative w-full h-24 bg-gray-100 rounded-lg overflow-hidden border border-gray-100 group-hover:border-blue-100 transition-colors">
                                {t.thumbnail ? (
                                    <img
                                        src={t.thumbnail}
                                        alt={t.title}
